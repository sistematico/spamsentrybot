...
$(function(){
    ...
    //////////////////////////////////////////////////////////////////////////////
    // Colorful Menu
    $('.left-menu .left-menu-list-root > li').hover(function() {
        $(this).addClass('left-menu-list-color-primary');
      }, function() {
        $(this).removeClass('left-menu-list-color-primary');
    });
